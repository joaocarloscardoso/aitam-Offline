module.exports = [
    ...
        {code:'byn', name:'Blin'},
        {code:'cad', name:'Caddo'},
        {code:'cai', name:'Central American Indian languages'},
    ...
        {code:'cmc', name:'Chamic languages'},
        {code:'cnr', name:'Montenegrin'},
        {code:'cop', name:'Coptic'},
        {code:'cor', name:'Cornish'},
        {code:'cos', name:'Corsican'},
        {code:'cpe', name:'Creoles and pidgins, English based'},
        {code:'cpf', name:'Creoles and pidgins, French-based'},
        {code:'cpp', name:'Creoles and pidgins, Portuguese-based'},
        {code:'cre', name:'Cree'},
        {code:'crh', name:'Crimean Turkish'},
        {code:'crp', name:'Creoles and pidgins'},
        {code:'csb', name:'Kashubian'},
        {code:'cus', name:'Cushitic languages'},
        {code:'cze', name:'Czech'},
        {code:'dak', name:'Dakota'},
        {code:'dan', name:'Danish'},
        {code:'dar', name:'Dargwa'},
        {code:'day', name:'Land Dayak languages'},
    ...
        {code:'fiu', name:'Finno-Ugrian languages'},
        {code:'fon', name:'Fon'},
    ...
        {code:'glv', name:'Manx'},
        {code:'gmh', name:'German, Middle High (ca.1050-1500)'},
        {code:'goh', name:'German, Old High (ca.750-1050)'},
        {code:'gon', name:'Gondi'},
    ...
        {code:'gsw', name:'Alemannic'},
        {code:'guj', name:'Gujarati'},
        {code:'gwi', name:'Gwichin'},
        {code:'hai', name:'Haida'},
    ...
        {code:'him', name:'Himachali languages'},
        {code:'hin', name:'Hindi'},
    ...
        {code:'kha', name:'Khasi'},
        {code:'khi', name:'Khoisan languages'},
    ...
        {code:'nog', name:'Nogai'},
        {code:'non', name:'Norse, Old'},
        {code:'nor', name:'Norwegian'},
        {code:'nqo', name:'NKo'},
        {code:'nso', name:'Northern Sotho'},
        {code:'nub', name:'Nubian languages'},
        {code:'nwc', name:'Old Newari'},
        {code:'nya', name:'Chewa'},
    ...
        {code:'orm', name:'Oromo'},
        {code:'osa', name:'Osage'},
        {code:'oss', name:'Ossetic'},
        {code:'ota', name:'Turkish, Ottoman (1500-1928)'},
        {code:'oto', name:'Otomian languages'},
    ...
        {code:'peo', name:'Persian, Old (ca.600-400 B.C.)'},
        {code:'per', name:'Persian'},
        {code:'phi', name:'Philippine languages'},
        {code:'phn', name:'Phoenician'},
        {code:'pli', name:'Pali'},
        {code:'pol', name:'Polish'},
        {code:'pon', name:'Pohnpeian'},
        {code:'por', name:'Portuguese'},
        {code:'pra', name:'Prakrit languages'},
        {code:'pro', name:'Provençal, Old (to 1500)'},
    ...
        {code:'sal', name:'Salishan languages'},
    ...
        {code:'son', name:'Songhai languages'},
        {code:'sot', name:'Sotho, Southern'},
        {code:'spa', name:'Español'},
        {code:'srd', name:'Sardinian'},
        {code:'srn', name:'Sranan Tongo'},
        {code:'srp', name:'Serbian'},
        {code:'srr', name:'Serer'},
        {code:'ssa', name:'Nilo-Saharan languages'},
        {code:'ssw', name:'Swati'},
    ...
        {code:'vot', name:'Votic'},
        {code:'wak', name:'Wakashan languages'},
        {code:'wal', name:'Wolaytta'},
        {code:'war', name:'Waray'},
        {code:'was', name:'Washo'},
        {code:'wel', name:'Welsh'},
        {code:'wen', name:'Sorbian languages'},

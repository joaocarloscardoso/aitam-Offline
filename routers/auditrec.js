...
auditrec.get('/auditrecs',function(req,res){
    ...
    if (status) {
        trace.AddActivity(global.WorkSetPath + req.sessionID + '_trace.txt', req.sessionID, NewAuditFile, 0, 'Recommendations > Recommendations Table accessed', 'Recommendations');
...
auditrec.get('/deleteauditrec/:auditrecId',function(req,res){
    ...
    if (status) {
        trace.AddActivity(global.WorkSetPath + req.sessionID + '_trace.txt', req.sessionID, NewAuditFile, 1, 'Recommendations > Recommendation deleted', 'Recommendations');

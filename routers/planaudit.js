...
planaudit.get('/auditplanning',function(req,res){
    ...
    if (status) {
        trace.AddActivity(global.WorkSetPath + req.sessionID + '_trace.txt', req.sessionID, NewAuditFile, 0, 'Plan > Risk table accessed', 'Plan');
...
planaudit.post('/auditplanning', function(req, res){
    ...
    if (status) {
        ...
        if(req.body.constructor === Object && Object.keys(req.body).length === 0) {
            ...
            trace.AddActivity(global.WorkSetPath + req.sessionID + '_trace.txt', req.sessionID, NewAuditFile, 1, 'Plan > Risk table modified', 'Plan');
...
planaudit.get('/syncauditplanning',function(req,res){
    ...
    if (status) {
        ...
        trace.AddActivity(global.WorkSetPath + req.sessionID + '_trace.txt', req.sessionID, NewAuditFile, 1, 'Plan > Sync between Risk table and Preliminary Activities done', 'Plan');
